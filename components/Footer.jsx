          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-1/2 px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Nighty</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Leggings</a>
                </li>
                <li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-1/2 px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Shocks</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Slipper</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Shandels</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-1/2 px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Purse</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Braclet</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Ring</a>
                </li>
              </nav>
            </div>
          </div>
