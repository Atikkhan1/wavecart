...
const Searchbar = (p) => {
  return (
    <div className={'flex h-10 md:m-auto md:w-1/2 max-md:w-full border-4 border-current rounded-full bg-pink-600 text-pink-600 ' + p.className}>
      <input className='w-full text-black rounded-l-full indent-4 focus:outline-none ' type="text" name="" id="" />
